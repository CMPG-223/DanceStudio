...
namespace CMPG223_18
{
    public partial class frmReports : Form
    {
        ...
        private void rdbTop3Dance_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblGrootExplanation.Visible = true;
            ...
            else if (rdbOutPay.Checked)
            {
                ...
                try
                {
                    using (SqlConnection con = new SqlConnection(connectString))
                    {
                        ...
                        string showReport = @"SELECT Dancer_FName AS [First Name], Dancer_LName AS [Surname], 
                                                Dancer_Total_All_Classes AS [Fee for all classes], Total_Received [Total Payments Received],  " +
                                                "Dancer_Total_All_Classes - Total_Received AS [Outstanding Payments] FROM Dancer " +
